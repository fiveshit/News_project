...
<project version="4">
  ...
  <component name="ChangeListManager">
    <list default="true" id="d5ad750d-6dac-4ed3-9fe9-712619fa2bb3" name="Default Changelist" comment="" />
  ...
  <component name="ExecutionTargetManager" SELECTED_TARGET="Android_TV_1080p_API_25" />
  ...
  <component name="FileEditorManager">
    <leaf SIDE_TABS_SIZE_LIMIT_KEY="300">
      ...
      <file pinned="false" current-in-tab="false">
        <entry file="file://$PROJECT_DIR$/app/src/main/res/layout/activity_recommend.xml">
          <provider selected="true" editor-type-id="text-editor">
